...
const PageTabs = () =>(
	<div className="col-md-12 nav-link-wrap">
	    <div className="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
	        <a className="nav-link  active" id="v-pills-1-tab" >Espace PRELEVEUR</a>
	        <a className="nav-link " id="v-pills-2-tab" >Espace MEDECIN</a>
	        <a className="nav-link " id="v-pills-3-tab" >Assurance Qualite</a>
	        <a className="nav-link " id="v-pills-4-tab" >COLLABORATEUR</a>
	        <a className="nav-link " id="v-pills-5-tab" >PALER AVEC NOUS</a>
	    </div>
	</div>
)
